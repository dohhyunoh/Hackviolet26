...
<body>
  ...
  <div class="disclaimer">
    <strong>Clinical Disclaimer:</strong> This report is generated by Clarity (AI-Assist). It identifies patterns consistent with PCOS/Endometriosis but DOES NOT constitute a medical diagnosis. The risk assessment is based on limited biometric data and should be interpreted by a qualified healthcare provider.
  </div>

  <div class="footer">
    <p>Clarity • Privacy-First Women's Health • End-to-End Encrypted</p>
